...
public class AppointmentFormDialog extends JDialog {
    ...
    private JTextField departmentComboBox, specializationComboBox, doctorNameComboBox;
    ...
    public AppointmentFormDialog() {
        ...
        searchButton = new JButton(new ImageIcon(new ImageIcon("C:\\Users\\Milind P\\QuestWorkspace\\AppointmentSchedulingSystem\\images\\lens.png")
    ...
    private void submit() {
        try {
            ...
            String department = departmentComboBox.getText();
            String doctorName = doctorNameComboBox.getText();
            Date appointmentDate = appointmentDateChooser.getDate();
            Date appointmentTime = (Date) appointmentTimeSpinner.getValue();

            if (selectedPatient == null || department.isEmpty() || doctorName.isEmpty() || appointmentDate == null || appointmentTime == null) {
